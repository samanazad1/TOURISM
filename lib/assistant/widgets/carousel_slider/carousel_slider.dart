...
import 'carousel_controller.dart' as cr;
...
class CarouselSlider extends StatefulWidget {
  ...
  CarouselSlider(
      ...
      this.disableGesture,
      cr.CarouselController? carouselController,
      Key? key})
      : itemBuilder = null,
        itemCount = items != null ? items.length : 0,
        carouselController = carouselController != null
            ? carouselController as CarouselControllerImpl
            :cr. CarouselController() as CarouselControllerImpl,
        super(key: key);
...
class CarouselSliderState extends State<CarouselSlider>
  ...
  void initState() {
    ...
    widget.carouselController
        .nextPage(duration: const Duration(milliseconds: 0));
    handleAutoPlay();
